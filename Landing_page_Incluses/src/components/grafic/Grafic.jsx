  ...
  useEffect(() => {
    ...
    return(
        <div className={style.geral} style={{backgroundColor:pegarTemaAtual()}} value={fundoDiv}>
            ...
            <iframe title="bi_incluses_terceiro_ano" width="80%" height="873.5" src="https://app.powerbi.com/view?r=eyJrIjoiYzYyODMxZjQtYWRkZi00YTY5LWE1YTQtOGM2ZTJkMzQ2ZWZiIiwidCI6ImIxNDhmMTRjLTIzOTctNDAyYy1hYjZhLTFiNDcxMTE3N2FjMCJ9" frameborder="0" allowFullScreen="true"></iframe>
            </div>
        </div>
    )
}
