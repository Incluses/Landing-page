...
function InclusesFinal() {
    ...
    return (
        <>
            <div id={style.divMae}>
                <img src="src/assets/Group 218.png" alt="Imagem do app Incluses" id={style.app}/>
                <div id={style.texto}>
                    <img src="src/assets/Group 184.png" alt="Logo do app Incluses" id={style.logo}/>
                    <p>Diversis acontece onde tecnologia e <br />diversidade se encontram.</p>
                </div>
                
            </div>
            <div id={style.barraStatus}>
                    <img src="src/assets/Group 221.png" alt="incluses" id={style.incluses}/>
